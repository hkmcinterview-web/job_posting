...
CARDIMG_WORDS = ("카드이미지", "이미지카드", "직접카드", "imgcard")
LOGO_WORDS = ("로고", "logo")
...
def detect_mode(text: str):
    ...
    {'cafe','card','job','expand','cancel','finish','news','trend',
     ...
     'community','card_image','logo','logo_clear',None}"""
